<?php //var_dump($this->session->userdata('admin_message'));die; ?>
            ...
            <div class="card shadow mb-4">
                ...
                <div id="frame">
                    ...
                    <div class="content">
                        ...
                        <?= form_open('Vender/send_message/'.$this->uri->segment(4)) ?>
                    ...
                    <script>
//                        $(document).ready(function(){
//                            $.get('<?//= site_url('Vender/checki/'.$user_info[0]['id']) ?>//',function (data) {
//                                alert(data);
//                                $('#show').val(data);
//                            });
//                            $('#send').click(function(){
//                               var x = $('#message').val();
//                                $.post('<?//= site_url('Vender/send_message/'.$user_info[0]['id']) ?>//',{message:x,user_id:'<?//= $user_info[0]['id'] ?>//',account_type:'vendor'},function(e){
//                                    $('#message').val(' ');
//                                    $.get('<?//= site_url('Vender/send_message/'.$user_info[0]['id']) ?>//',function(e){
//                                        $('#show').val(e);
//                                        alert(e);
//                                    });
//                                });

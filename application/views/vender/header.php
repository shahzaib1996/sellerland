                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <!-- Counter - Messages -->
                            <span class="badge badge-danger badge-counter"><?php if(!empty($_SESSION['admin_message'][$this->uri->segment(4)])){echo count($_SESSION['admin_message'][$this->uri->segment(4)]);} ?></span>
                        </a>
                        <!-- Dropdown - Messages -->
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                            ...
                            <?php $id = array();if(!empty($admin_message)){ foreach($admin_message as $k=>$v){
                                if(empty($id)){ $x=1; ?>
                                    <a class="dropdown-item d-flex align-items-center" href="<?= site_url('Vender/view/support_messages1/'.$v['user_id']) ?>">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src="https://source.unsplash.com/fn_BT9fwg_E/60x60" alt="">
                                            <div class="status-indicator bg-success"></div>
                                        </div>
                                        <div class="font-weight-bold">
                                            <div class="text-truncate"><?= $v['username']  ?><span class="badge badge-pill badge-primary left"><?= $x ?></span></div>
                                    ...
                                    foreach($id as $k1=>$v1){
                                        if($v1 != $v['user_id']){?>
                                            <a class="dropdown-item d-flex align-items-center" href="<?= site_url('Vender/view/support_messages1/'.$v['user_id']) ?>">
                                                ...
                                                <div class="font-weight-bold">
                                                    <div class="text-truncate"><?= $v['username']  ?><span class="badge badge-pill badge-primary"><?= $x ?></span></div>
                                                    <div class="small text-gray-500">Emily Fowler · 58m</div>
                                                </div>
                                            </a>
                                            <?php $id[] = $v['user_id'];break;
                                        }else{
                                            break;
                                        }
                                    }

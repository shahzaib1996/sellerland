...
<!-- Page level plugins -->
<script src="<?= base_url();?>bootstrap/vendor/chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?= base_url();?>bootstrap/js/demo/chart-area-demo.js"></script>
<script src="<?= base_url();?>bootstrap/js/demo/chart-pie-demo.js"></script>

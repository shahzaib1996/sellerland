...
<style>
            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content vendor-parent-links col-lg-12">
                       <img src="<?= base_url() ?>/image/profile_image/<?= $vendor[0]['img'] ?>" alt="" class="img-fluid vendor-img">
                    <p class="vendor-name "><a class="text-light" style="font-size: 18px;text-transform: uppercase;"> <?= $vendor[0]['store_name'] ?> </a>
                        <!-- premium icon-->
                    ...
                    <p class="vendor-links">
                      <a class="text-light" href="<?= site_url('Main/view/vendor-contact/'.$vendor[0]['id']) ?>">Contact</a>
                      <a href="<?= site_url('Main/view/vendor-feedback/'.$vendor[0]['id']) ?>" class="text-light">Feedback</a>
                      <!-- <a href="<?= site_url('Main/view/vendor-groups/'.$vendor[0]['id']) ?>" class="text-light">Product Groups</a> -->
                    </p>
                    </div>	
                </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12" style="text-align: center;">
              ...
              <form action="" style="text-align: center;" method="GET">
                ...
                <input type="text" class="form-control" name="search" value="<?php if(isset($_GET['search'])) echo $_GET['search']; ?>" placeholder="enter here to search . . ." style="float: left;width: 50%;margin-left: 10px;"> 
        ...
        <section class="content-section container pb-5">
                <div class="row pt20">
                  <div class="col-lg-12" style="margin-bottom: 10px;"> <span style="border: 1px solid grey;border-radius: 10px;padding: 5px;">  <?php echo count($vendor_products); ?> Products Found </span> </div>
                    <?php $x=0; 
                    if( count($vendor_products) != 0 ) {
                    foreach ($vendor_products as $k=>$v){ ?>

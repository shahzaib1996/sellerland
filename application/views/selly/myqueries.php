            ...
            <div class="col-lg-12 mb-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">My All Queries</h6>
                </div>
                ...
                <table class="table table-bordered" cellspacing="0" style="margin-top: 20px;">
                    ...
                    <?php $x=1; if(count($myqueries) != 0) { foreach ($myqueries as $k=>$v) {?>
                        <tr>
                            <td><?=$x; $x++?></td>
                            <td><?=$v['title']?></td>
                            <td><?=$v['email']?></td>
                    ...
                    <?php } } else { echo "<tr><td colspan='5' style='text-align:center;'> No Queries Found! </td></tr> "; } ?>
